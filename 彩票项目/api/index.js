...
const apiList = {
	doXianXiaRecharge:(data)=> {
		return http.request({
			url: 'user/doXianXiaRecharge',
			method: 'GET',
			data
		})
	},
	...
	getGuanYaData:(data)=> {
		return http.request({
			url: 'index/getGuanYaData',
			method: 'GET',
			data
		})
	},
	getBeijingGames:(data)=> {
		return http.request({
			url: 'index/beijingGames',
			method: 'GET',
			data
		})
	},
	...
	getRealAuthentication:(data)=> {
		return http.request({
			url: 'user/getRealAuthentication',
			method: 'GET',
			data
		})
	},
