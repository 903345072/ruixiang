/**
 * 通用uni-app网络请求
 * 基于 Promise 对象实现更简单的 request 使用方式，支持请求和响应拦截1
 */
import tool from '../tool/tool'
export default {
	config: {
		// baseUrl: "http://192.168.1.192:807/",
		url:"http://8.130.113.143:8787",
		baseUrl: "http://8.130.113.143:8787/api/",
		header: {
