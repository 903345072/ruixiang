...
<script>
	export default{
		...
		methods:{
			...
			doorder(){
				var dd = Object.assign([],this.check_game) 
				...
				var data = {"type":this.game_type,"num":num_,"checkGame":JSON.stringify(dd),"bei":this.bei,"mode":this.mode,"chuan":JSON.stringify(chuan_arr),"num_arr":JSON.stringify(this.num_arr),"plan_desc":this.plan_desc,"is_open":this.is_open,'expect_min_award':this.expect_min_award,'expect_max_award':this.expect_max_award,'pl_type':this.pl_type}
